...
" Generated by http://bytefluent.com/vivify 2012-03-16
set background=dark
if version > 580
  hi clear
  if exists("syntax_on")
...
set t_Co=256
let g:colors_name = "jellybeans_black"
...
hi CursorLine                    guifg=NONE      guibg=#0F0F0F   guisp=#0F0F0F   gui=NONE        ctermfg=NONE   ctermbg=234    cterm=NONE
...
hi cformat                       guifg=#d0939f   guibg=#40090a   guisp=#40090a   gui=NONE        ctermfg=174    ctermbg=52     cterm=NONE
hi comment                       guifg=#888888   guibg=NONE      guisp=NONE      gui=italic      ctermfg=102    ctermbg=NONE   cterm=NONE
hi conditional                   guifg=#a57ecc   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=140    ctermbg=NONE   cterm=NONE
hi constant                      guifg=#cf6a4c   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=173    ctermbg=NONE   cterm=NONE
hi cspecialcharacter             guifg=#d0939f   guibg=#40090a   guisp=#40090a   gui=NONE        ctermfg=174    ctermbg=52     cterm=NONE
hi cursorim                      guifg=#40090a   guibg=#ffa1ff   guisp=#ffa1ff   gui=NONE        ctermfg=52     ctermbg=219    cterm=NONE
hi directory                     guifg=#dad085   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=186    ctermbg=NONE   cterm=NONE
hi doxygenbrief                  guifg=#c6fd79   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=192    ctermbg=NONE   cterm=NONE
hi doxygencomment                guifg=#6cad33   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=107    ctermbg=NONE   cterm=NONE
hi doxygenparam                  guifg=#c6fda8   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=193    ctermbg=NONE   cterm=NONE
hi doxygenprev                   guifg=#c6fda8   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=193    ctermbg=NONE   cterm=NONE
hi doxygensmallspecial           guifg=#c6fda8   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=193    ctermbg=NONE   cterm=NONE
hi doxygenspecial                guifg=#c6fda8   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=193    ctermbg=NONE   cterm=NONE
hi doxygenspecialmultilinedesc   guifg=#68ad1e   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=70     ctermbg=NONE   cterm=NONE
hi doxygenspecialonelinedesc     guifg=#68ad1e   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=70     ctermbg=NONE   cterm=NONE
hi function                      guifg=#fad07a   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=222    ctermbg=NONE   cterm=NONE
hi identifier                    guifg=#c6b6ee   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=183    ctermbg=NONE   cterm=NONE
hi javadocseetag                 guifg=#cc1616   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=160    ctermbg=NONE   cterm=NONE
hi keyword                       guifg=#feb0b0   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=217    ctermbg=NONE   cterm=NONE
hi lcursor                       guifg=#40090a   guibg=#a1fff9   guisp=#a1fff9   gui=NONE        ctermfg=52     ctermbg=159    cterm=NONE
hi longlinewarning               guifg=NONE      guibg=#372321   guisp=#372321   gui=underline   ctermfg=NONE   ctermbg=237    cterm=underline
hi mbechanged                    guifg=#ee1818   guibg=#3d373f   guisp=#3d373f   gui=NONE        ctermfg=196    ctermbg=237    cterm=NONE
hi mbenormal                     guifg=#c9cfc1   guibg=#3d373f   guisp=#3d373f   gui=NONE        ctermfg=187    ctermbg=237    cterm=NONE
hi mbevisiblechanged             guifg=#ee1818   guibg=#8f5f8f   guisp=#8f5f8f   gui=NONE        ctermfg=196    ctermbg=96     cterm=NONE
hi mbevisiblenormal              guifg=#11cf11   guibg=#8f5f8f   guisp=#8f5f8f   gui=NONE        ctermfg=40     ctermbg=96     cterm=NONE
hi normal                        guifg=#e8e8d3   guibg=#000000   guisp=#000000   gui=NONE        ctermfg=187    ctermbg=233    cterm=NONE
hi number                        guifg=#ff8888   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=210    ctermbg=NONE   cterm=NONE
hi operator                      guifg=#ff8888   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=196    ctermbg=NONE   cterm=NONE
hi perlspecialmatch              guifg=#d0939f   guibg=#40090a   guisp=#40090a   gui=NONE        ctermfg=174    ctermbg=52     cterm=NONE
hi perlspecialstring             guifg=#d0939f   guibg=#40090a   guisp=#40090a   gui=NONE        ctermfg=174    ctermbg=52     cterm=NONE
...
hi rubyescape                    guifg=#ff8888   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=196    ctermbg=NONE   cterm=NONE
...
hi rubyinterpolation             guifg=#ff8888   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=196    ctermbg=NONE   cterm=NONE
hi rubyinterpolationdelimiter    guifg=#8FBFDC   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=19     ctermbg=NONE   cterm=NONE
hi rubypredefinedidentifier      guifg=#de5577   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=168    ctermbg=NONE   cterm=NONE
hi rubypseudovariable            guifg=#444499   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=61     ctermbg=NONE   cterm=NONE
...
hi rubystringdelimiter           guifg=#15ffa5   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=49     ctermbg=NONE   cterm=NONE
...
hi taglisttagname                guifg=#df97ed   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=176    ctermbg=NONE   cterm=NONE
hi type                          guifg=#cdffcd   guibg=NONE      guisp=NONE      gui=NONE        ctermfg=194    ctermbg=NONE   cterm=NONE
hi user1                         guifg=#1582ff   guibg=#5e485c   guisp=#5e485c   gui=NONE        ctermfg=33     ctermbg=59     cterm=NONE
hi user2                         guifg=#a08081   guibg=#5e485c   guisp=#5e485c   gui=NONE        ctermfg=138    ctermbg=59     cterm=NONE
